    ...
    <div className="overflow-hidden relative w-full h-full flex flex-col rounded-lg">
      ...
      <div className="flex flex-col gap-[20px] items-center justify-center flex-1 px-4">
        ...
        <div className="flex flex-col items-center justify-center pt-8">
          <div className="text-grey-900 text-6xl text-center font-bold uppercase w-full">transfering</div>
          <div className="flex gap-[5px] items-center justify-center w-full">
            <div className="text-grey-900 text-6xl text-center font-bold uppercase">t</div>
            <div className="h-[48px] relative rounded-full w-[125.07px] border-[4.648px] border-primary border-solid"></div>
            <div className="text-grey-900 text-6xl text-center font-bold uppercase">anyone</div>
          </div>
        </div>
        ...
        <div className="flex gap-1 items-center justify-center w-full max-w-md">
          ...
          <div className="relative mr-2">
            <div
              ...
              className="bg-white flex gap-1 items-center justify-start pl-1.5 pr-2 py-0.5 rounded-full border border-grey-200 cursor-pointer hover:border-pink-350 transition-colors"
            >

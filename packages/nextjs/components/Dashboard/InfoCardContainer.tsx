  ...
  return (
    <>
      <span className="grid xl:grid-cols-3 grid-cols-1 gap-2 w-full justify-between">
        <span className="relative flex-1 h-[120px] block bg-gradient-to-r from-[#FF7CEB] to-[#FFACF2] rounded-xl overflow-hidden">
          <span
        ...
        <span className="relative flex-1 h-[120px] block bg-gradient-to-r from-[#CEEFE8] to-[#9DCFF0] rounded-xl overflow-hidden">
          <span
        ...
        <span className="relative flex-1 h-[120px] block bg-gradient-to-r from-[#BBB4F7] to-[#6D2EFF] rounded-xl overflow-hidden">
          <span
